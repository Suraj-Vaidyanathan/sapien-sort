...
const CurrentPackageCard: React.FC<CurrentPackageCardProps> = ({
  ...
  return (
    <Card className="p-3 bg-blue-50 border-blue-200 h-full w-full">
      <div className="flex items-center justify-between mb-2">
        <h3 className="text-base font-semibold text-gray-800">Current Package</h3>
      ...
      {packageId ? (
        <div className="space-y-2">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xs text-gray-600">Package ID:</span>
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xs text-gray-600">Assigned Bot:</span>
            <span className="font-medium text-blue-600 text-xs">{assignedBot}</span>
          </div>
          <div className="flex items-center space-x-2">
            <span className="text-xs text-gray-600">Current Row:</span>
